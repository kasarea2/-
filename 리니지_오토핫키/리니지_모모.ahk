...
잡화상찾기:
	...
	while(findJobHwa) {
		...
		sleep, 2000
		PostMessage, 0x202, 0, %lparam%, RenderWindow1, %WindowName%
		sleep, 1000
...
DragClick(cX, cY, cUpDown) {
	...
	PostMessage, 0x201, 1, %lparam%, RenderWindow1, %WindowName%
	Sleep, 100
	PostMessage, 0x201, 1, %lyparam%, RenderWindow1, %WindowName%

	Sleep, 200
	PostMessage, 0x202, 0, %lyparam%, RenderWindow1, %WindowName%
}
